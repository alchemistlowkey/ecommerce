    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          {/* xxxxxxxxxxxxxxxxxxx Payment Method Selection xxxxxxxxxxxxxxxxxx */}
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={()=>navigate('/orders')} className='bg-black hover:rounded-full text-white px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
